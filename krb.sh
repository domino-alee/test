mkdir /opt/test && cd /opt/test && cp -r /opt//spark/conf/ . && wget https://github.com/domino-alee/test/raw/master/keystore.jks && wget https://github.com/domino-alee/test/raw/master/truststore.jks && chmod -R 777 /opt/test
...
echo "HDFS_CONF_DIR=/opt/test/conf" >> /opt/bitnami/spark/conf/spark-env.sh
...
echo "HDFS_CONF_DIR=/opt/test/conf" >> /opt/test/conf/spark-env.sh
...
export HDFS_CONF_DIR=/opt/test/conf
